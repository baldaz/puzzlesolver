 ...
 * the character it represents, and nearby pieces informations at his four
 * cardinal points, provided with getters.
 */
...
public class Piece implements IPiece {
	 ...
	 * @param p reference to a piece of the puzzle that could be at north of the
	 * current one
	 ...
	 * @param p reference to a piece of the puzzle that could be at east of the
	 * current one
	 ...
	 * @param p reference to a p piece of the puzzle that could be at south of the
	 * current one
	 ...
	 * @param p reference to a piece of the puzzle that could be at west of the
	 * current one
