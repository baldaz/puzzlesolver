...
/**
 * File model representing an input and output file for puzzles, derived from
 * abstract IOFile.
 */

public class IOPuzzle extends IOFile {

	private static Charset charset = StandardCharsets.UTF_8; // UTF-8 encoding
	 ...
	 * from Puzzle reference from super class IOFile into the file placed in
	...
	public void write() {
		...
		try (BufferedWriter writer =
				Files.newBufferedWriter(Paths.get(outpath()), charset)) {
