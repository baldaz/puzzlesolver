...
/**
 * Shared sort status class, represent a shared object needed to communicate
 * the sort status of the puzzle of every thread
 */
...
public class SharedSortStat {
	...
	/**
	 * @return true if top thread has finished his job sorting top half of the
	...
	/**
	 * @return true if bottom thread has finished his job sorting bottom half
	...
	public synchronized void setTopWitten() {
		top_writ = true;
	}
}
