...
public class Piece implements IPiece, Serializable {
	 ...
	 * @param p a reference to a piece of the puzzle that could be at north of
	 * the current one
	 ...
	 * @param p a reference to a piece of the puzzle that could be at east of the
	 * current one
	 ...
	 * @param p a reference to a piece of the puzzle that could be at south of
	 * the current one
	 ...
	 * @param p a reference to a piece of the puzzle that could be at west of the
	 * current one
